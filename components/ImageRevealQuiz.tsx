            ...
            {showLink && (
              <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-90 p-4 text-center">
                <a
                  ...
                  className="text-[#1a8f1a] text-sm sm:text-lg md:text-xl lg:text-2xl font-bold hover:text-[#23b323] transition-all duration-300 neon-text hover:scale-110 hover:shadow-glow"
                >
        ...
        <form onSubmit={handleSubmit} className="relative z-10 w-full px-2">
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 w-full">
            <input
              ...
              className={`w-full sm:flex-grow p-2 sm:p-3 border-2 ${
                isIncorrect ? "border-red-500" : "border-[#1a8f1a]"
